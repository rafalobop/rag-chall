...
class GuardrailValidator:
    ...
    def __init__(self):
        # Construir patrón de compilación para pronombres de palabra completa e insensibles a mayúsculas/minúsculas
    ...
    def validate(self, text: str) -> Tuple[bool, str]:
        ...
        # Regla 3: Tercera persona (ausencia de pronombres de 1ª o 2ª persona)
